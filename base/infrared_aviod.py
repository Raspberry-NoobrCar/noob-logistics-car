...
def run():
    ...
    pwm_ENA.ChangeDutyCycle(forward_speed)
    pwm_ENB.ChangeDutyCycle(forward_speed)
...
#     key_scan()
    ...
    while True:
        ...
        print("LeftSensorValue",LeftSensorValue)
        print("RightSensorValue",RightSensorValue)
